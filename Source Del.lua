...
[ . مطور السورس ](t.me/t.me/uuuuuuuuueu)
...
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* عذرآ هاذا الامر يخص : نائب المديريه فقط *')
end
...
send(msg.chat_id_, msg.id_," عذرآ البوت ليس مشرف") 
return false  
end
...
send(msg.chat_id_, msg.id_,[[
أهلا بك عزيزي فيفي قائمة الألعاب في البوت
 معاني .
حزوره .  
 العكس .
محيبس .
...
send(msg.chat_id_, msg.id_,' المجموعه عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل المجموعه ضاهر وليس مخفي ومن بعدها يمكنك مشرف ثم تفعيلي') 
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' البوت ليس مشرف يرجى ترقيتي !') 
