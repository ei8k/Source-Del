...
io.write('\n\27[1;35mSend Token For Bot : أرسل التوكن  ...\n\27[0;39;49m')
local token = io.read()
if token = '' then
...
io.write('\n\27[1;35m⬇Send UserName For Sudo : أرسل معرف Dev 🎖️...\n\27[0;39;49m')
...
io.write('\n\27[1;35m⬇Send id For Sudo : أرسل ايدي Dev 🎖️...\n\27[0;39;49m')
local User_Sudo = io.read()
if User_Sudo = '' then
...
send(chat,msg.id_,"* عذرأ الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")   
end      
...
send(chat,msg.id_,"\nتم رفع الملف بنجاح وتفعيل المجموعات\n ورفع {الامالكين الاساسين ; والمالكين ; والمدراء; ونائبين المدراء} بنجاح")   
end
...
send(msg.chat_id_, msg.id_,"\n لقد فزت في اللعبه \n اللعب مره اخره وأرسل - سمايل او سمايلات")
...
send(msg.chat_id_, msg.id_,"\n لقد فزت في اللعبه \n اللعب مره اخره وأرسل - الاسرع او ترتيب")
redis:incrby(bot_id.."NightRang:Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_," عذرأ لا يوجد سواء { 6 } اختيارات فقط أرسل اختيارك مره اخرى\n")
return false 
end 
...
send(msg.chat_id_,0, "عذرأ يا ⇠ [@"..data.username_.."]\n  الملصق الذي أرسلته تم منعه من المجموعه \n" ) 
else
send(msg.chat_id_,0, "عذرأ يا ⇠ ["..data.first_name_.."](T.ME/NightRang)\n الملصق الذي أرسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ = false then
send(msg.chat_id_,0,"عذرأ يا ⇠ [@"..data.username_.."]\n الصوره التي أرسلتها تم منعها في المجموعة \n" ) 
else
send(msg.chat_id_,0,"عذرأ يا ⇠ ["..data.first_name_.."](T.ME/NightRang)\n الصوره التي أرسلتها تم منعها في المجموعة \n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ = false then
send(msg.chat_id_,0,"عذرأ يا ⇠ [@"..data.username_.."]\n المتحركه التي أرسلتها تم منعها من المجموعه \n") 
else
send(msg.chat_id_,0,"عذرأ يا ⇠ ["..data.first_name_.."](T.ME/NightRang)\n المتحركه التي أرسلتها تم منعها من المجموعه \n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_," أرسل الامر الجديد ليتم وضعه مكان القديم")  
...
send(msg.chat_id_, msg.id_," أرسل التحذير عند ارسال الكلمه")  
...
'\n أرسل كلمة  تفعيل  ليتم تفعيل المجموعه'..
...
send(msg.chat_id_, msg.id_, ' حسنا أرسل لي معرف القناة') 
return false  
end
...
send(msg.chat_id_, msg.id_, ' حسنا أرسل لي النص الذي تريده') 
return false  
end
...
return send(msg.chat_id_, msg.id_,"أرسل السؤال الان ")
end
...
send(msg.chat_id_, msg.id_,' أرسل الان الكليشه ليتم وضعها') 
end
...
send(msg.chat_id_, msg.id_," أرسل لي التوجيه الان\n ليتم افتاراته في المجموعات") 
return false
end
...
send(msg.chat_id_, msg.id_,"  أرسل لي الاسم الان ")  
return false
end
if text == ("مسح قائمة العام") then
redis:del(bot_id.."NightRang:Removal:User:Groups")
send(msg.chat_id_, msg.id_, " - أهلأ عزيزي ال Dev 🎖️
- تم مسح المحظورين عام في البوت .")
end
...
[Surus developer](https://t.me/uuuuuuuuueu)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
return send(msg.chat_id_,msg.id_,'* - عذرأ عزيزي 
- ألرفع معطل .*')
end
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* -> عذرأ عزيزي هذأ إلامر يخص فقط 
- ( نائب المدير ، المدير ، المالك ، المالك الاساسي ، Dev 🎖️ ) . *')
end
...
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* -> عذرأ عزيزي هذأ إلامر يخص
- المدراء فقط .*')
end
redis:set(bot_id.."NightRang:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))
...
send(msg.chat_id_, msg.id_,"* -> عذرأ عزيزي
المعرف غلط*")
end
end,nil)
end
...
send(msg.chat_id_, msg.id_," - عذرأ عزيزي البوت 
- ليس مشرف .") 
return false  
end
...
send(msg.chat_id_, msg.id_,'- عذرأ عزيزي
- لقد تم تعطيل الحظر و الطرد من قبل المالكين .')
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"- عذرأ عزيزي البوت 
...
KickGroup(msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","- أهلا عزيزي
- تم طرد العضو .")  
end,nil)   
end
else
...
Send_Options(msg,result.sender_user_id_,"reply","-> أهلا عزيزي 
- هو ليس مدير أصلأ")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
...
if text == ("نائبين المدراء") and Owner(msg) then
local list = redis:smembers(bot_id.."NightRang:Admin:Group"..msg.chat_id_)
if #list == 0 then
return send(msg.chat_id_, msg.id_, " -> عذرأ عزيزي
لأيوجد نائبين مدراء")
end
Admin = "\n قائمة نائبين المدراء في المجموعه\n————————\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
send(msg.chat_id_,msg.id_," -> عذرأ عزيزي
- التثبيت والغاء التثبيت تم قفلة من قبل المالكين")  
return false  
end
local url , res = https.request('https://api.telegram.org/bot'..token..'/unpinAllChatMessages?chat_id='..msg.chat_id_)
if res == 200 then
send(msg.chat_id_, msg.id_," - أهلأ عزيزي
 تم مسح تثبيت كل الرسائل المثبتة")   
redis:del(bot_id..'Pin:Id:Msg'..msg.chat_id_)
elseif res == 400 then
send(msg.chat_id_,msg.id_," -> عذرأ عزيزي
يرجى ترقيتي مشرف او ليست لدي صلاحية تثبيت الرسائل يرجى التحقق من الصلاحيات والمحاولة مرا اخرى")  
end
end
...
send(msg.chat_id_, msg.id_, "  - أهلأ بك عزيزي 
- تم مسح المالكين الأساسيين في المجموعة .")
end
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم قفل التثبيت .  ")  
elseif text ==  "قفل التعديل" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص - مالك - مالك اساسي *')
end 
redis:set(bot_id.."NightRang:Lock:edit"..msg.chat_id_,true) 
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم قفل التعديل .  ")  
elseif text ==  "قفل تعديل الميديا" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص - مالك - مالك اساسي *')
end 
redis:set(bot_id.."NightRang:Lock:edit"..msg.chat_id_,true) 
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم قفل التعديل الميديا .  ")  
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم قفل الأوامر .  ")  
elseif text ==  "فتح الاضافه" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:AddMempar"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح اضافة الأعضاء  .  ")  
elseif text ==  "قفل السب" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end 
redis:set(bot_id.."lock:Fshar"..msg.chat_id_,true)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم قفل السب  .  ")  
elseif text ==  "قفل الايموجي" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end 
redis:set(bot_id.."lock:emoje"..msg.chat_id_,true)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم قفل الأيموجي  .  ")  
elseif text ==  "فتح السب" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end 
redis:del(bot_id.."lock:Fshar"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم فتح السب  .  ")  
elseif text ==  "فتح الايموجي" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end 
redis:del(bot_id.."lock:emoje"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم فتح الأيموجي  .  ")  
elseif text ==  "فتح الدردشه" then
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'*- أهلا عزيزي \n - عذرأ الأمر يخص - مدير - مالك*')
end 
redis:del(bot_id.."NightRang:Lock:text"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح الدردشه  .  ")  
elseif text ==  "فتح الدخول" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:Join"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح دخول الأعضاء  .  ")  
elseif text ==  "فتح البوتات" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:Bot:kick"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح البوتات  .  ")  
elseif text ==  "فتح البوتات " then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end 
redis:del(bot_id.."NightRang:Lock:Bot:kick"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status","\n - أهلأ بك عزيزي - تم فتح البوتات  .  ")  
elseif text ==  "فتح الاشعارات" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end  
redis:del(bot_id.."NightRang:Lock:tagservr"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح الأشعارات  .  ")  
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح التثبيت  .  ")  
elseif text ==  "فتح التعديل" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص - مالك - مالك اساسي *')
end 
redis:del(bot_id.."NightRang:Lock:edit"..msg.chat_id_) 
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح التعديل  .  ")  
elseif text ==  "فتح التعديل الميديا" then
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص - مالك - مالك اساسي *')
end 
redis:del(bot_id.."NightRang:Lock:edit"..msg.chat_id_) 
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح التعديل الميديا  .  ")  
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح الاوامر  .  ")  
elseif text ==  "قفل الروابط" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Link"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - تم قفل الروابط بالتقييد .  ")  
elseif text ==  "قفل الروابط بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Link"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid"," - أهلأ بك عزيزي - تم قفل الروابط بالكتم  .  ")  
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm"," - أهلأ بك عزيزي - تم قفل الروابط بالطرد .  ")  
elseif text ==  "قفل الروابط بالطرد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Link"..msg.chat_id_,"kick")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," - أهلأ بك عزيزي - تم قفل الروابط  .  ")  
elseif text ==  "فتح الروابط" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:del(bot_id.."NightRang:Lock:Link"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - تم فتح الروابط  .  ")  
elseif text ==  "قفل المعرفات" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:User:Name"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - - أهلأ بك عزيزي - تم قفل المعرفات  .   بالتقييد  .  ")  
elseif text ==  "قفل المعرفات بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:User:Name"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid"," - أهلأ بك عزيزي - - أهلأ بك عزيزي - تم قفل المعرفات  .   بالكتم  .  ")  
elseif text ==  "قفل المعرفات بالكتم" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:User:Name"..msg.chat_id_,"ktm")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm"," - أهلأ بك عزيزي - - أهلأ بك عزيزي - تم قفل المعرفات  .   بالطرد  .  ")  
elseif text ==  "قفل المعرفات بالطرد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:User:Name"..msg.chat_id_,"kick")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," - أهلأ بك عزيزي - تم قفل المعرفات  .  ")  
elseif text ==  "فتح المعرفات" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:del(bot_id.."NightRang:Lock:User:Name"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - فتح  المعرفات  .  ")  
elseif text ==  "قفل التاك" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:hashtak"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - قتفل التاك  .  ")  
elseif text ==  "قفل التاك بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:hashtak"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid"," - أهلأ بك عزيزي - قفل التاك  .  ")  
elseif text ==  "قفل التاك بالكتم" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:hashtak"..msg.chat_id_,"ktm")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm"," - أهلأ بك عزيزي - قفل التاك  .  ")  
elseif text ==  "قفل التاك بالطرد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:hashtak"..msg.chat_id_,"kick")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," - أهلأ بك عزيزي - قفل التاك  .  ")  
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - قفل الشارحه بالتقييد  .  ")  
elseif text ==  "قفل الشارحه بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Cmd"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid"," - أهلأ بك عزيزي - قفل الشارحه بالكتم .  ")  
elseif text ==  "قفل الشارحه بالكتم" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Cmd"..msg.chat_id_,"ktm")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm"," - أهلأ بك عزيزي - قفل الشارحه بالطرد  .  ")  
elseif text ==  "قفل الشارحه بالطرد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Cmd"..msg.chat_id_,"kick")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," - أهلأ بك عزيزي - قفل الشارحه  .  ")  
elseif text ==  "فتح الشارحه" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:del(bot_id.."NightRang:Lock:Cmd"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - فتح الشارحه  .  ")  
elseif text ==  "قفل الصور"then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Photo"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - قفل الصور بالتقييد .  ")  
elseif text ==  "قفل الصور بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Photo"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid"," - أهلأ بك عزيزي - قفل الصور بالكتم  .  ")  
elseif text ==  "قفل الصور بالكتم" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Photo"..msg.chat_id_,"ktm")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm"," - أهلأ بك عزيزي - قفل الصور بالطرد  .  ")  
elseif text ==  "قفل الصور بالطرد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Photo"..msg.chat_id_,"kick")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," - أهلأ بك عزيزي - قفل الصور  .  ")  
elseif text ==  "فتح الصور" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:del(bot_id.."NightRang:Lock:Photo"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - فتح الصور  .  ")  
elseif text ==  "قفل الفيديو" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Video"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - قفل الفيديو بالتقييد .  ")  
elseif text ==  "قفل الفيديو بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Video"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid"," - أهلأ بك عزيزي - قفل الفيديو بالكتم  .  ")  
elseif text ==  "قفل الفيديو بالكتم" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Video"..msg.chat_id_,"ktm")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm"," - أهلأ بك عزيزي - قفل الفيديو بالطرد  .  ")  
elseif text ==  "قفل الفيديو بالطرد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Video"..msg.chat_id_,"kick")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," - أهلأ بك عزيزي - قفل الفيديو  .  ")  
elseif text ==  "فتح الفيديو" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:del(bot_id.."NightRang:Lock:Video"..msg.chat_id_)  
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," - أهلأ بك عزيزي - فتح الفيديو  .  ")  
elseif text ==  "قفل المتحركه" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Animation"..msg.chat_id_,"del")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," - أهلأ بك عزيزي - قفل المتحركهم بالتقييد.  ")  
elseif text ==  "قفل المتحركه بالتقييد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Animation"..msg.chat_id_,"ked")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kid"," - أهلأ بك عزيزي - قفل المتحركه بالكتم .  ")  
elseif text ==  "قفل المتحركه بالكتم" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Animation"..msg.chat_id_,"ktm")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm"," - أهلأ بك عزيزي - قفل المتحركه بالطرد .  ")  
elseif text ==  "قفل المتحركه بالطرد" then
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* - أهلا عزيزي \n عذرأ الامر يخص- نائب مدير - مدير*')
end
redis:set(bot_id.."NightRang:Lock:Animation"..msg.chat_id_,"kick")  
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," - أهلأ بك عزيزي - قفل المتحركه  .  ")  
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick"," أهلأ بك عزيزي
- تم قفل التكرار .")
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status_Ktm"," أهلأ بك عزيزي
- تم قفل التكرار .")
...
return Send_Options(msg,msg.sender_user_id_,"Open_Status"," أهلأ بك عزيزي
- تم فتح التكرار .")
end
...
return send(msg.chat_id_, msg.id_,' -> أهلأ عزيزي
تم تفعيل ألرابط المجموعة') 
end
...
return send(msg.chat_id_, msg.id_,'-> أهلأ عزيزي
تم تفعيل الردود العامة في المجموعة ' ) 
end
...
return send(msg.chat_id_, msg.id_,'-> أهلأ عزيزي
تم تعطيل الردود العامة في المجموعة ' ) 
end
...
send(msg.chat_id_, msg.id_,' امر مين ضافني تم تعطيلة من قبل المدراء ') 
end
end
...
send(msg.chat_id_,msg.id_,"- أرسل رابط المجموعه او رابط قناة المجموعة .")
...
send(msg.chat_id_,msg.id_," أرسل الصوره لوضعها") 
return false 
end
...
send(msg.chat_id_,msg.id_," أرسل الان الوصف")
return false 
end
...
send(msg.chat_id_,msg.id_," أرسل لي الترحيب الان".."\n تستطيع اضافة مايلي !\n دالة عرض الاسم »{`name`}\n دالة عرض المعرف »{`user`}") 
return false 
end
...
send(msg.chat_id_,msg.id_," أرسل لي القوانين الان")  
return false 
end
...
send(msg.chat_id_, msg.id_," أرسل الكلمه لمنعها")  
...
send(msg.chat_id_, msg.id_," أرسل الكلمه الان")  
...
send(msg.chat_id_, msg.id_, "  يرجى ترقيتي مشرف !") 
return false
end  
local num = 0 
...
local yazon = "  عدد نائبين المدراء : "..data.administrator_count_..
...
if #list == 0 then
text = " عذرأ لا يوجد الردود في المجموعه"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
return false 
end
...
send(msg.chat_id_, msg.id_," أرسل الان الكلمه لاضافتها في الردود ")
redis:set(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "مسح رد" and Owner(msg) then

send(msg.chat_id_, msg.id_," أرسل الان الكلمه لمسحها من الردود")
...
send(msg.chat_id_, msg.id_," أرسل الان الكلمه لاضافتها في الردود العامه ")
redis:set(bot_id.."NightRang:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "مسح رد عام" and DeveloperBot1(msg) then
 
send(msg.chat_id_, msg.id_," أرسل الان الكلمه لمسحها من الردود العامه ")
...
send(msg.chat_id_, msg.id_," الان أرسل لي الامر القديم ...")  
return false 
end
...
send(msg.chat_id_, msg.id_," أرسل الان الامر الذي قمت بوضعه مكان الامر القديم")  
return false 
end
...
send(msg.chat_id_, msg.id_, " أرسل لي عدد الرسائل الان") 
return false
end
...
send(msg.chat_id_, msg.id_, " أرسل لي عدد النقاط الان") 
end
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ = 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_, "\n  عذرأ لا استطيع طرد "..Get_Rank(msg.sender_user_id_,msg.chat_id_).." ")
return false
end
...
send(msg.chat_id_, msg.id_,"  عذرأ لا استطيع طرد مشرفين المجموعه") 
return false  
end
...
return send(msg.chat_id_, msg.id_,"أرسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"أرسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"تم حفظ الرد الاول أرسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"تم حفظ الرد الثاني أرسل الرد الثالث")
return false  
end  
end
if text then  
...
if not Constructor(msg) then
send(msg.chat_id_,msg.id_,'- أهلا عزيزي \n عذرأ الامر يخص - مالك - مالك اساسي فقط')
return false
end
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," عذرأ عزيزي المستخدم هذا معرف قناة يرجى استخدام الامر بصوره صحيحه ")   
return false 
end      
...
send(msg.chat_id_,msg.id_,'
-> عذرأ عزيزي
 هذا الامر خاص بالمالك الاساسي فقط')
return false
end
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
...
if Admin(msg) then
local Text =[[
* أهلأ بك عزيزي في قائمة اوامر بوت ديل 🎖️*
 ————————
...
{
{text = 'Dev', callback_data=msg.sender_user_id_.."/ ]].. UserName_Dev..[[
]]"},{text = 'Channel source', callback_data=msg.sender_user_id_.."/ ]].. UserName_Dev..[["},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,' أرسل الان معرف Dev 🎖️الجديد')
return false
end
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," عذرأ عزيزي هذا معرف قناة يرجى ارسال المعرف مره اخره")   
return false 
end      
...
if text == 'Channel source' and Admin(msg) then
...
if text == 'Dev' and Owner(msg) then
...
redis:del(bot_id.."NightRang:Admin:Group"..msg.chat_id_)
redis:del(bot_id.."NightRang:Vip:Group"..msg.chat_id_)
return send(msg.chat_id_, msg.id_, "  - أهلا بك عزيزي
تم مسح جميع ألرتب")
end
...
send2(msg.chat_id_, msg.id_, 'أرسل رمز بدلا عن هاذا \n ————————')
return false
end
...
send2(msg.chat_id_, msg.id_, 'الان أرسل رمز بدلا عن  ')
...
send(msg.chat_id_, msg.id_,' ا-> عذرأ عزيزي , المجموعة عادية وليست خارقة يجب ان تضع رسائل المجموعة ضاهر ومن بعدها يمكنك ترقيتي مشرف ثم تفعيلي') 
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' -> عذرأ عزيزي
...
send(msg.chat_id_, msg.id_,' -> عذرأ , لأ يمكنك تفعيل المجموعة بسبب قلة عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'NightRang:Num:Add:Bot') or 0)..'* عضو')
return false
end
if redis:sismember(bot_id..'NightRang:ChekBotAdd',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' عذرأ عزيزي , المجموعة مفعلة مسبقأ')
else
local Texti = 'أهلأ عزيزي ، تم تفعيل المجموعة'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_,' أهلأ عزيزي ،  المجموعة معطله مسبقأ')
else
Send_Options(msg,result.id_,'reply_Add',' أهلأ عزيزي ، تم تعطيل المجموعة '..chat.title_..'')
redis:srem(bot_id..'NightRang:ChekBotAdd',msg.chat_id_)  
...
if not Dev_Bots(msg) then
sendText(Id_Dev,' أهلأ عزيزي ، تم تعطيل المجموعة جديده\n'..'\n بواسطة : '..Name..''..'\n ايدي المجموعه : `'..IdChat..'`\n اسم المجموعه : ['..NameChat..']',0,'md')
end
end
end,nil) 
end,nil) 
...
{
{text = 'Dev', callback_data=data.sender_user_id_.."/ ]].. UserName_Dev..[[
]]"},{text = 'Channel source', callback_data=data.sender_user_id_.."/ ]].. UserName_Dev..[["},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
